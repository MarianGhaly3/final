				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
							action="{{ route('BeverageInserted') }}" method="POST" enctype="multipart/form-data">
							@csrf
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" id="title" required="required" class="form-control "
										name="beverageName" value="{{ old('beverageName') }}">
									<p style="color:red">
										@error('beverageName')
											{{$message}}
										@enderror
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<textarea id="content" name="content" required="required" class="form-control"
										value="{{ old('content') }}">Contents</textarea>
									<p style="color:red">
										@error('content')
											{{$message}}
										@enderror
								...
								<div class="col-md-6 col-sm-6 ">
									<select class="form-control" name="category_id" id=" ">
										...
										@foreach($categories as $category)
										 <option value= "{{ $category->id }}" {{ old('category_id') ? 'selected' : '' }} > {{ $category->category }} </option>
										@endforeach
